...
void CustomCANbusSetup(){
    CustomCAN0.begin(CAN_1000KBPS);
    SPI.setClockDivider(1,9);
    CustomCAN0.init_Mask(0, 0, 0x7F0);
    CustomCAN0.init_Mask(1, 0, 0x7f0);
    CustomCAN0.init_Filt(0, 0, 0x700);
    CustomCAN0.init_Filt(1, 0, 0x710);
    CustomCAN0.init_Filt(2, 0, 0x720);
    CustomCAN0.init_Filt(3, 0, 0x730);
    CustomCAN0.init_Filt(4, 0, 0x740);
    CustomCAN0.init_Filt(5, 0, 0x750);
...
void SendMessageToTeensy(char id, byte d1){
    SendMessageToTeensy(id,d1,random(255),random(255),random(255),random(255),random(255));
}

void SendMessageToTeensy(char id, byte d1, byte d2){
    SendMessageToTeensy(id,d1,d2,random(255),random(255),random(255),random(255));
}

void SendMessageToTeensy(char id, byte d1, byte d2, byte d3){
    SendMessageToTeensy(id,d1,d2,d3,random(255),random(255),random(255));
}

void SendMessageToTeensy(char id, byte d1, byte d2, byte d3, byte d4){
    SendMessageToTeensy(id,d1,d2,d3,d4,random(255),random(255));
}

void SendMessageToTeensy(char id, byte d1, byte d2, byte d3, byte d4, byte d5){
    SendMessageToTeensy(id,d1,d2,d3,d4,d5,random(255));
}

void SendMessageToTeensy(char id, byte d1, byte d2, byte d3, byte d4, byte d5, byte d6){
    serialTeensy.print(id);
    serialTeensy.write(d1);
    serialTeensy.write(d2);
    serialTeensy.write(d3);
    serialTeensy.write(d4);
    serialTeensy.write(d5);
    serialTeensy.write(d6);
    serialTeensy.write(id^d1^d2^d3^d4^d5^d6);
    serialTeensy.print('>');
}

void ReceiveTeensySerial(){
