...
//  is called XEthernet and is a user library in the SketchBook/Libraries folder.

#include <SPI.h>
#include <XEthernet.h>
#include <XEthernetUDP.h>
#include <SD.h>
...
const IPAddress infoServer(192,168,1,200);
...
EthernetUDP starterUDP;  // A UDP instance to let us listen for incoming connections from the starter controller
...
void loop() {
    ...
    if(tierFourCounter>250000){
        tierFourCounter=0;
        // do teir four tasks
        boolean webserve = CheckAndDoWebServer();
    }
